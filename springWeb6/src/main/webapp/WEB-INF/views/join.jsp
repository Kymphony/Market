...
<table align="center">
	...
	<tr>
		...
		<td><input type="text" name="custid" id="custid" 
			readonly="readonly" placeholder="아이디 중복확인을 먼저 이용하세요" style="height:45px; width:210px; border-style:radius;"></td>
	...
	<tr>
		<th>이름</th>
		<td><input type="text" name="name" id="name" style="height:45px; width:210px;"></td>
	</tr>
	<tr>
		<th>가입 구분</th>
	...
	<tr>
		...
		<td><input type="text" name="idno" id="idno" maxlength="13" placeholder=" - 없이 입력" pattern="[0-9]{13}" style="height:45px; width:210px;"></td>
	</tr>
	<tr>
		<th>이메일</th>
		<td>
	...
	<tr>
		<th>주소</th>
		<td colspan="2"><textarea rows="4" cols="40" name="address" id="address" style="height:50px; width:300px;"></textarea></td>
	</tr>
	<tr>
